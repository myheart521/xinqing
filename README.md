...
选用的是 2025 年 8 月保存的完整演示，其中有金蝶云苍穹的适配画面。仓库中的应用主体是 Vue、UniApp 和 Spring Boot，金蝶平台需要单独接入。视频保留原来的功能顺序和主要旁白，个人资料、咨询记录、服务地址等区域已经遮盖。各功能出现的时间见[视频导航](docs/MEDIA.md)。
...
项目历次参赛及平台适配版本的获奖情况如下，年份、赛段和等级按保存的证书与获奖公示整理。
...
公开记录不列参赛作品题名、团队名单和证书编号，原始证书也不上传。记录范围见 [AWARDS.md](docs/AWARDS.md)；大学生创新训练计划的立项、结项不计入竞赛奖项。
