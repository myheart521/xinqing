  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <div class="row">
        ...
        <input type="text" id="apiPrefix" v-model="apiPrefix" :disabled="connected"
               placeholder="例如：/dev-api，不需要则留空"/>
      </div>
      <div class="row">
        <label></label>
        <div>
...
import SseFileDownloaderClass from '@/utils/sse-file-downloader.js';

// 响应式状态
const userId = ref(1);
const baseUrl = ref('/dev-api/api/sse1');
