<template>
  <view id="_root" :class="(selectable?'_select ':'')+'_root'" :style="(editable?'min-height:200px;':'')+containerStyle" @tap="_containTap">
    ...
    <!-- #endif -->
    <view v-if="tooltip" class="_tooltip_contain" :style="'top:'+assets.example.invalid+'px'">
      <view class="_tooltip">
        <view v-for="(item, index) in tooltip.items" v-bind:key="index" class="_tooltip_item" :data-i="index" @tap="_tooltipTap">{{item}}</view>
      </view>
    </view>
    <view v-if="slider" class="_slider" :style="'top:'+assets.example.invalid+'px'">
    ...
    <view v-if="color" class="_tooltip_contain" :style="'top:'+assets.example.invalid+'px'">
